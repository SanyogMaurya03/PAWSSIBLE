                    ...
                    %>
                    	...
                    	<div class="col-lg-4"> 
      						<div class="panel panel-primary">
        						...
        						<div class="panel-body"><%=qs.getProductname()%><img src="Homepage/img2/dog10.jpg" class="img-responsive" style="height:195px; width:100%" alt="Image"></div>
        						<div class="panel-footer">Age : <%=qs.getPrice()%><br>Area Pincode <%=qs.getQuantity()%></div>
        				...
        				<input type="hidden" name="productid"value="<%=qs.getProductid()%>">
        						<button id="myBtn" class="btn btn-danger"
                        			onclick="openMyDialog(<%=qs.getProductid()%>)">Adoptr</button>
     							</div>
     							 </div>
