...
<%
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="mainNav">
                <ul class="navbar-nav ">
                    <li class="nav-item">
                        <a class="nav-link smoth-scroll" href="additemtoproduct.jsp">Add Dogs</a>
                    </li>
                	<!-- <li class="nav-item">
                        <a class="nav-link smoth-scroll" href="addcategoryform.jsp">Add Category</a>
                    </li> -->
                    <li class="nav-item">
                        <a class="nav-link smoth-scroll" href="deletecategoryform.jsp">Delete Adoption</a>
                    </li>
                    <!-- <li class="nav-item">
                        <a class="nav-link smoth-scroll" href="vieworders.jsp">View Unconfirmed Adoptions</a>
                    </li> -->
                    <li class="nav-item">
                        <a class="nav-link smoth-scroll" href="viewallproductsadmin.jsp">View Available Dogs</a>
                    </li>
