                    ...
                    <tr>
                        ...
                        <td><%=p.getDescription()%></td>
                         ...
                         <td>
                            ...
                            <input class = "btn btn-danger" id="myBtn2" type="submit" value="Remove From Adoption"/>
                            </form>
                        </td>
                        
                        <td>
                        	<button id="myBtn" class="btn btn-danger"
                        	onclick="openMyDialog(<%=p.getProductid()%>)">Update This Adoption</button>
                        </td>  
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <table class="table table-hover">
        <tr>
            <th align="center"> <b>Enter Dog Details To Be Updated : </b></th>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
            	<label class="control-label" for="price">Enter Age</label> 
                <input type="text" class="form-control" id="price" name="price"/>
            </td>
        </tr>
        <tr>
            <td>
            	<label class="control-label" for="quantity">Enter Area Pincode</label> 
