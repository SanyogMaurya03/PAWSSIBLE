...
<title>Add Dog For Adoption</title>
</head>
            ...
            <div class="col-md-6">
                ...
                <fieldset><legend class="text-center">All Fields <span class="req"><small> required *</small></span></legend>
                    ...
                    <div class="form-group">
                        <label for="productname"><span class="req">* </span> Dog Name </label>
                        <input required name="productname" type="text" class="form-control inputpass" minlength="4" maxlength="30"  id="productname" /> </p>
    				</div>
    				<div class="form-group">	
                        <label for="categoryid"><span class="req">* </span> Dog Gender </label>
                    ...
                    <div class="form-group">
                        <label for="price"><span class="req">* </span> Age </label> 
                            <input class="form-control" required type="text" name="price" id = "price" />   
                                <div class="status" id="status"></div>
                    </div>
                    
                    <div class="form-group">
                        <label for="quantity"><span class="req">* </span>Area Pincode </label>
                        <input required type="text" name="quantity" id="quantity" class="form-control" max="999999" min="18" onkeyup="validatequantity(this);" placeholder="Enter your pincode here"/> 
                    </div>
                ...
                <div class="form-group">
                    <input class="btn btn-success" type="submit" name="submit_reg" value="Upload Dog For Adoption">
                </div>
                </fieldset>
           </form>
                 </div>
