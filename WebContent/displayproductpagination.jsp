...
<nav class="navbar " id="new" >
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="displayproductpagination.jsp" id="head">Dogs For Adoption</a></li>
            ...
            for (Product qs : lst) {
            	...
            	<div class="col-lg-4">
            		<div class="grid-container">
            			<br><br>
            			<div class="grid-item"><%=qs.getProductid()%><br><%=qs.getProductname()%><br><img src="Homepage/img2/dog4.jpg" class="img-responsive" style="height:195px; width:100%" alt="Image"><br>Age : <%=qs.getPrice()%><br>Area Pincode <%=qs.getQuantity()%><br><button id="myBtn" class="btn btn-danger"
                        			onclick="openMyDialog(<%=qs.getProductid()%>)">Adopt</button></div>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <table class="table table-hover">
        <tr>
            <th align="center"> <b>Enter Details to adopt : </b></th>
        </tr>
        <tr>
            <td>
            	<label class="control-label" for="quantity">Enter Dog Id</label> 
